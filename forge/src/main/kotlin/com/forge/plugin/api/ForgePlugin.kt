...
data class PluginMetadata(
    val id: String,                         // "com.forge.plugin.react"
    ...
    val homepage: String = "",              // "https://github.com/forge/plugin-react"
    val repository: String = "",            // "https://github.com/forge/plugin-react"
    ...
    val peerDependencies: Map<String, String> = emptyMap() // {"@forge/js": "^1.0.0"}
)
...
data class MigratorSchema(
    ...
    val cli: String = "forge",              // CLI command that should run this migration
