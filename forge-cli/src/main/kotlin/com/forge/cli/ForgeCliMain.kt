...
class GenerateCommand : CliktCommand() {
    ...
    private val packageName by option("--package", "-p", help = "Base package name for generated classes")
        .default("com.forge.plugin.generated")
    ...
    private fun generatePlugin() {
        ...
        try {
            ...
            val forgeExtension = spec.get("x-forge-plugin")
            val pluginId = forgeExtension?.get("id")?.asText() ?: "com.forge.plugin.${actualPluginName.lowercase()}"
            ...
            echo("   - forge-plugin-generator")
            echo("")
            echo("2. Use OpenAPI Generator CLI with your custom generators:")
            echo("   openapi-generator generate -g forge-plugin-generator -i ${specFile.absolutePath} -o $outputPath")
            echo("")
